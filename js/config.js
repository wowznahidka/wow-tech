const CFG = {
  GAS_URL:  '',
  TG_URL:   'https://t.me/wowtech',
  IG_URL:   'https://instagram.com/wow.tech',
  TT_URL:   'https://www.tiktok.com/@wowtech',
  GA_ID:    '',
  FB_PIXEL_ID: '',
  TT_PIXEL_ID: '',
  OG_IMAGE: '',
  CACHE_KEY:    'wow_tech_v1',
  CACHE_TTL_MS: 5 * 60 * 1000,
  MIN_PRODUCTS: 5,
  SIZES_MALE:   ['64GB','128GB','256GB','512GB','1TB'],
  SIZES_FEMALE: ['64GB','128GB','256GB','512GB'],
  SIZES_ALL:    ['64GB','128GB','256GB','512GB','1TB'],
  HOT_SIZES_MALE:   ['128GB','256GB'],
  HOT_SIZES_FEMALE: ['128GB','256GB'],
  GRID_BATCH: 24,
  MATCH_HISTORY_KEY: 'wow_tech_seen',
};
